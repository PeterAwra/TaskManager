    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_search:
                ...
                FragmentManager supportFragmentManager = getSupportFragmentManager();
                supportFragmentManager.beginTransaction().hide(supportFragmentManager.getFragments().get(0))
                        .hide(supportFragmentManager.getFragments().get(1))
                        .add(R.id.vp,new AddTaskFragment()).addToBackStack("task").show(new ProductivityFragment()).commit();
