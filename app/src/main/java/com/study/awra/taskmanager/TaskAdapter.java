...
class TaskAdapter extends RecyclerView.Adapter<TaskViewHolder> {
  ...
  public void setClickLongTaskList(ClickLongTaskList clickLongTaskList) {
    mClickLongTaskList = clickLongTaskList;
  }
  ...
  public void completedItem(int pos) {
    ...
    SharedPreferences sharedPreferences =
        mContext.getSharedPreferences(SAVE_COMPLETED_TASK, Context.MODE_PRIVATE);
