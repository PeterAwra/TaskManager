...
public class SwipeDeleteCompletedCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public SwipeDeleteCompletedCallback(TaskAdapter taskAdapter) {
        ...
        backgroundDelete = new ColorDrawable(taskAdapter.getContext().getResources().getColor(R.color.swipe_delete));
        backgroundSolve = new ColorDrawable(taskAdapter.getContext().getResources().getColor(R.color.swipe_completed));
