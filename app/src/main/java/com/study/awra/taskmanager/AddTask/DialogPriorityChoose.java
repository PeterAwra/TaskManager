...
public class DialogPriorityChoose extends DialogFragment implements OnClickPriorityItemListListener {
    ...
    public void onAttach(Context context) {
        ...
        if(context instanceof ChosenPriorityListener)
            ...
            throw new UnsupportedOperationException("Activity must implement interface ChosenPriorityListener");
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TaskPriorityAdapter adapter = new TaskPriorityAdapter(context.getResources().getIntArray(R.array.priority_color));
